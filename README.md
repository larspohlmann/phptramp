...
phptramp [options]
  ...
  --exclude-terminal <kind> Do not report chains ending in <kind> (repeatable; used|stored|fan-out|&-terminated|unused-end|external|truncated -- quote '&-terminated', or the shell backgrounds the command)
